...
if __name__ == "__main__":
    ...
    from algs.readfile import Spec
    from algs.dialogs import Der_Graph
...
class MyTabWidget(QtGui.QWidget):
    def __init__(self):
        ...
        self.data = Spec()
        self.dockgraf = Dock("Total", size=(700, 150))
        self.dockzoom = Dock("Zoom", size=(500, 120))
        self.dockinfo = Dock("Info Total", size=(700, 80))
        self.dockrep = Dock("Area de Reportes", size=(500, 300))
