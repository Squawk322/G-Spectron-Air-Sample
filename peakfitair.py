...
def peak_analysis_ind(SPEC, FWHMC, BGSTEP=True, lims=None):
    PLOT = False
    FITEO = {'x':0}
    BG=0
    PCHANN = np.append(SPEC.peaks.T[0], 4096)
